...
dataset_label = "gaussian_x2_aligned"
pixel_scales = 0.1
...
from gaussian.workspace.pipelines.initialize import x2_gaussian_aligned

pipeline__initialize = x2_gaussian_aligned.make_pipeline(
    pipeline_general_settings=pipeline_general_settings, phase_folders=[dataset_label]
)

from gaussian.workspace.pipelines.main import x2_gaussian

pipeline__main = x2_gaussian.make_pipeline(
    pipeline_general_settings=pipeline_general_settings, phase_folders=[dataset_label]
)
