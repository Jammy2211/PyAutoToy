...
def make__gaussian_x1(sub_size):
    ...
    gaussian = g.SphericalGaussian(centre=(0.0, 0.0), intensity=10.0, sigma=0.5)
...
def make__gaussian_x1__input_sigma(sub_size, sigma):
    ...
    gaussian = g.SphericalGaussian(centre=(0.0, 0.0), intensity=10.0, sigma=sigma)
...
def make__gaussian_x2(sub_size):
    ...
    gaussian_0 = g.SphericalGaussian(centre=(0.0, 1.0), intensity=10.0, sigma=0.5)
    gaussian_1 = g.SphericalGaussian(centre=(0.0, -1.0), intensity=10.0, sigma=0.5)
...
def make__gaussian_x2_aligned(sub_size):

    data_type = "gaussian_x2_aligned"

    # This lens-only system has a Dev Vaucouleurs spheroid / bulge.

    gaussian_0 = g.SphericalGaussian(centre=(0.0, 0.0), intensity=5.0, sigma=0.5)
    gaussian_1 = g.SphericalGaussian(centre=(0.0, 0.0), intensity=20.0, sigma=3.0)
...
def make__gaussian__sub_gaussian(sub_size):
    ...
    gaussian_0 = g.SphericalGaussian(centre=(0.0, 0.0), intensity=10.0, sigma=1.0)
    gaussian_1 = g.SphericalGaussian(centre=(0.5, 0.5), intensity=0.2, sigma=0.1)
