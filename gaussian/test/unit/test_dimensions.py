...
class TestLength(object):
    def test__conversions_from_arcsec_to_kpc_and_back__errors_raised_if_no_kpc_per_arcsec(
        ...
        unit_arcsec = g.dim.Length(value=2.0)
...
class TestLuminosity(object):
    def test__conversions_from_eps_and_counts_and_back__errors_raised_if_no_exposure_time(
        ...
        unit_eps = g.dim.Luminosity(value=2.0)
...
class MockDimensionsProfile(g.dim.DimensionsProfile):
    def __init__(
        self,
        position: g.dim.Position = None,
        param_float: float = None,
        length: g.dim.Length = None,
        luminosity: g.dim.Luminosity = None,
    ):
    ...
    class TestUnitProperties(object):
        def test__extracts_length_correctly__raises_error_if_different_lengths_input(
            ...
            profile = MockDimensionsProfile(
                position=(
                    g.dim.Length(value=3.0, unit_length="arcsec"),
                    g.dim.Length(value=3.0, unit_length="arcsec"),
                ),
                length=g.dim.Length(3.0, "arcsec"),
            )
            ...
            profile = MockDimensionsProfile(
                position=(
                    g.dim.Length(value=3.0, unit_length="kpc"),
                    g.dim.Length(value=3.0, unit_length="kpc"),
                ),
                length=g.dim.Length(3.0, "kpc"),
            )
        ...
        def test__extracts_luminosity_correctly__raises_error_if_different_luminosities(
            ...
            profile = MockDimensionsProfile(luminosity=g.dim.Luminosity(3.0, "eps"))

            assert profile.unit_luminosity == "eps"

            profile = MockDimensionsProfile(luminosity=g.dim.Luminosity(3.0, "counts"))
    ...
    class TestUnitConversions(object):
        def test__arcsec_to_kpc_conversions_of_length__float_and_tuple_length__conversion_converts_values(
            ...
            profile_arcsec = MockDimensionsProfile(
                position=(g.dim.Length(1.0, "arcsec"), g.dim.Length(2.0, "arcsec")),
                param_float=2.0,
                length=g.dim.Length(value=3.0, unit_length="arcsec"),
                luminosity=g.dim.Luminosity(value=4.0, unit_luminosity="eps"),
            )
