...
def make_gaussian_0():
    ...
    return g.SphericalGaussian(centre=(0.0, 0.0), intensity=1.0, sigma=0.5)


@pytest.fixture(name="gaussian_1")
def make_gaussian_1():
    # noinspection PyTypeChecker
    return g.SphericalGaussian(centre=(0.5, 0.5), intensity=2.0, sigma=1.0)
