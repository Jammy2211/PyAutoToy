...
class TestPhaseTaggers:
    def test__sub_size_tagger(self):
        ...
        assert tag == "__sub_1"
        tag = toy.phase_tagging.sub_size_tag_from_sub_size(sub_size=2)
        assert tag == "__sub_2"
        tag = toy.phase_tagging.sub_size_tag_from_sub_size(sub_size=4)
        assert tag == "__sub_4"

    def test__signal_to_noise_limit_tagger(self):

        tag = toy.phase_tagging.signal_to_noise_limit_tag_from_signal_to_noise_limit(
    ...
    def test__bin_up_factor_tagger(self):
        ...
        tag = toy.phase_tagging.bin_up_factor_tag_from_bin_up_factor(bin_up_factor=None)
        assert tag == ""
        tag = toy.phase_tagging.bin_up_factor_tag_from_bin_up_factor(bin_up_factor=1)
        assert tag == ""
        tag = toy.phase_tagging.bin_up_factor_tag_from_bin_up_factor(bin_up_factor=2)
        assert tag == "__bin_2"
        tag = toy.phase_tagging.bin_up_factor_tag_from_bin_up_factor(bin_up_factor=3)
        assert tag == "__bin_3"

    def test__real_space_shape_2d_tagger(self):

        tag = toy.phase_tagging.real_space_shape_2d_tag_from_real_space_shape_2d(
    ...
    def test__real_space_pixel_scales_tagger(self):
        ...
        tag = toy.phase_tagging.real_space_pixel_scales_tag_from_real_space_pixel_scales(
